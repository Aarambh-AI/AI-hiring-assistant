...
class ResumeFormat(BaseModel):
    ...
    gender: str = Field(default="Others", description=dedent("""Identify Gender of the candidate from the name provided in the resume. Gender can only have one value from the following list ["Male","Female", "Others"]."""))
